...
- 무료 도서 증정
    ...
    + [Do it! 쉽게 배우는 R 데이터 분석](https://bit.ly/2Wqbob4) 3권
- 참가신청: [등록 사이트](https://festa.io/events/199) 2월1일부터 티켓 오픈합니다.
...
- 발표 :    
    + 임상배(클라우데라): 제목 미정 
    + 홍운표(DataRobot): 제목 미정
    + 정도현(AWS): "데이터 과학자를 위한 AWS 서비스 소개"
- 도서 후원
